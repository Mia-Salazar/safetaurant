<?php 
  ...
  if(isset($_COOKIE['userID'])) {
    ...
    $score = addScore($formInfo['comment'], $formInfo['generalScore'], $formInfo['allergenChart'],  $formInfo['fidelityScore'], 
    $formInfo['attentionScore'], $formInfo['userName'], $formInfo['id'], $formInfo['restaurantID'], $formInfo['created'],
     $formInfo['allergicReaction']);
    if($score) {
